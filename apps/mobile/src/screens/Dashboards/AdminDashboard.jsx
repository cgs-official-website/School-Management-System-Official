...
const modules = [
  { id: '1', name: 'Overview', route: 'AdminOverview' },
  { id: '2', name: 'Classes', route: 'AdminClasses' },
  { id: '3', name: 'Students', route: 'AdminStudents' },
  { id: '4', name: 'Attendance', route: 'AdminAttendance' },
  { id: '5', name: 'Staff', route: 'AdminStaff' },
  { id: '6', name: 'Fees', route: 'AdminFees' },
  { id: '7', name: 'Timetables', route: 'AdminTimetables' },
  { id: '8', name: 'Exams', route: 'AdminExams' },
];
