...
import { LuPlus as Plus, LuTrash2 as Trash2, LuSave as Save, LuSettings as Settings, LuMoveUp as MoveUp, LuMoveDown as MoveDown, LuFolder as Folder } from 'react-icons/lu';
...
export default function FormBuilder() {
    ...
    try {
      ...
      if (schemaSnap.exists()) {
        ...
        if (data.sections) {
          ...
          // Backward compatibility: migrate old flat fields to a default section
          setSections([{
            id: `sec_${Date.now()}`,
  ...
  const removeSection = (secId) => {
    if (window.confirm("Are you sure you want to remove this entire section and its fields?")) {
    ...
    <div className="p-8 max-w-5xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Create dynamic custom sections and fields for different modules.</p>
        </div>
                  ...
                  <div className="p-4 space-y-4">
                    {section.fields.length === 0 ? (
                      ...
                      section.fields.map((field, fIndex) => (
                        <div key={field.id} className="p-4 border border-slate-200 rounded-xl bg-slate-50/50 flex gap-4 hover:border-slate-300 transition-colors">
                          <div className="flex flex-col justify-center gap-1 shrink-0 text-slate-400">
